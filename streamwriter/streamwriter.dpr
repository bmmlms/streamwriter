...
uses
  ...
  Plugins in 'postprocessing\Plugins.pas',
  PluginsShared in 'postprocessing\PluginsShared.pas',
  SetTags in 'postprocessing\SetTags.pas',
  PluginManager in 'postprocessing\PluginManager.pas',
  Logging in '..\..\common\Logging.pas',
  Timers in 'Timers.pas' {frmTimers},
  StreamData in 'StreamData.pas' {frmStreamData},
  SoX in 'postprocessing\SoX.pas',
  DownloadAddons in 'DownloadAddons.pas' {frmDownloadAddons},
  DownloadClient in '..\..\common\DownloadClient.pas',
  ConfigureSoX in 'postprocessing\ConfigureSoX.pas' {frmConfigureSoX},
  ...
  MP3Gain in 'postprocessing\MP3Gain.pas',
  ...
  ConfigureSetTags in 'postprocessing\ConfigureSetTags.pas' {Form1},
  MessageBus in '..\..\common\MessageBus.pas',
  AppMessages in 'AppMessages.pas',
  StatusBar in 'controls\StatusBar.pas',
  AACPostProcess in 'postprocessing\AACPostProcess.pas',
