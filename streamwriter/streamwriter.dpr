...
begin
  ...
  begin
    MsgBox(0, _('The BASS library or it''s AAC plugin could not be extracted/loaded. Without this library streamWriter can not record streams. Try to get help at streamWriter''s board.'), _('Error'), MB_ICONERROR);
    Bass.Free;
    Exit;
  end;
