...
type
  ...
  public
    ...
    class procedure ApplyAutoDefaults(S: TStreamSettings);
    ...
    class function LoadAuto(Stream: TExtendedStream; Version: Integer): TStreamSettings;
...
class procedure TStreamSettings.ApplyAutoDefaults(S: TStreamSettings);
var
  i: Integer;
begin
